{
  outputs =
    ...
    let
      ...
      system = "aarch64-linux"; # TODO: other architectures
    ...
    in
    {
      ...
      packages.${system} = with pkgs; {
        ...
        astal3 = mkPkg "astal" ./lib/astal/gtk3 [
          self.packages.${system}.io
          gtk3
          gtk-layer-shell
        ];
        astal4 = mkPkg "astal" ./lib/astal/gtk4 [
          self.packages.${system}.io
          gtk4
          gtk4-layer-shell
        ];
